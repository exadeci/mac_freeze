...
func createIconSet() {
    // Load the base icon from icons/ directory (use enabled version for app icon)
    guard let baseImage = NSImage(contentsOfFile: "icons/freezer_enabled.png") else {
        print("Error: Could not load icons/freezer_enabled.png")
        return
    }
